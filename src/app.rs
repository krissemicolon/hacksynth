...
impl Sandbox for App {
    ...
    fn new() -> App {
        let osc1 = Oscillator::default();
        let osc2 = Oscillator::default();
        ...
        audio::setup_output(midi_msgs.clone(), Arc::new(vec![Arc::new(osc1.clone()), Arc::new(osc2.clone())]));
